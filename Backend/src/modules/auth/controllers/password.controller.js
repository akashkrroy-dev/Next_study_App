...
import { resetTokenCookieOptions, clearResetTokenCookieOptions, clearRefreshTokenCookieOptions } from "../../../utils/cookieOptions.js";
...
export const verifyPasswordReset = async (req, res) => {
    try {
        ...
        res.clearCookie("resetToken", clearResetTokenCookieOptions)
